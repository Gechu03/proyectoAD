...
public class InterfazConsulta extends javax.swing.JFrame {
    ...
    private DAOEquipo dEquipo;
    /**
     * Creates new form InterfazConsulta
     */
    public InterfazConsulta(String nombre, DAOEquipo dEquipo) {
        initComponents();
        if(dEquipo != null){
    ...
    private void rellenarList(){
        ArrayList<Equipo> resultado = dEquipo.consultar(nombre);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazConsulta("", null).setVisible(true);
            }
        });
    }
